...
[root@k8s-master pki]# ls -lt|grep -i crt
-rw-r--r-- 1 root root 1135 3月  28 09:40 apiserver-etcd-client.crt
-rw-r--r-- 1 root root 1103 3月  28 09:40 front-proxy-client.crt
-rw-r--r-- 1 root root 1078 3月  28 09:40 front-proxy-ca.crt
-rw-r--r-- 1 root root 1143 3月  28 09:40 apiserver-kubelet-client.crt
-rw-r--r-- 1 root root 1269 3月  28 09:40 apiserver.crt
-rw-r--r-- 1 root root 1066 3月  28 09:40 ca.crt


[root@k8s-master pki]# for i in `ls -lt|grep -i crt|awk '{print $NF}'`
> do
> echo "######################"
> echo $i
> openssl x509 -in $i -noout -text|grep Not
> done
######################
apiserver-etcd-client.crt
            Not Before: Mar 28 01:40:05 2021 GMT
            Not After : Mar 28 01:40:06 2022 GMT
######################
front-proxy-client.crt
            Not Before: Mar 28 01:40:05 2021 GMT
            Not After : Mar 28 01:40:05 2022 GMT
######################
front-proxy-ca.crt
            Not Before: Mar 28 01:40:05 2021 GMT
            Not After : Mar 26 01:40:05 2031 GMT
######################
...
在每个master节点，执行以下命令，将证书延长到10年

```bash
[root@k8s-master pki]# ./update-kubeadm-cert.sh all
```
...
```bash
[root@k8s-master pki]# for i in `ls -lt|grep -i crt|awk '{print $NF}'`; do echo "######################"; echo $i; openssl x509 -in $i -noout -text|grep Not; done
######################
front-proxy-client.crt
            Not Before: Jun  3 20:42:03 2021 GMT
            Not After : Jun  1 20:42:03 2031 GMT
######################
apiserver-kubelet-client.crt
            Not Before: Jun  3 20:42:03 2021 GMT
            Not After : Jun  1 20:42:03 2031 GMT
...
```bash
[root@k8s-master pki]# kubectl -n ns-mysh get pods
NAME                                      READY   STATUS    RESTARTS   AGE
app-mysql-dev-0                           1/1     Running   3          13d
app-redis-dev-0                           1/1     Running   3          13d
buxybox-5f76f89f75-2mlwp                  1/1     Running   69         38d
buxyboxplus-868989cbd6-rw4cm              1/1     Running   68         38d
java-demo-75bb45fcb8-vgfxv                1/1     Running   54         19d
nfs-client-provisioner-7db6484544-5v2vx   1/1     Running   24         13d
nginx-app-9bc86dbd4-l2nqf                 1/1     Running   27         55d
zk-0                                      1/1     Running   34         13d
zk-1                                      1/1     Running   51         56d
```
